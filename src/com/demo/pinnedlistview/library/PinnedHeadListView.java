package com.demo.pinnedlistview.library;
 ...
 */
public class PinnedHeadListView extends ListView {
    ...
    public PinnedHeadListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void configureHeaderView(int position) {
        ...
        int state, nextSectionPosition = position + 1;
